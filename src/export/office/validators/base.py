...
class BaseSchemaValidator:
    ...
    def validate_xml(self):
        ...
        for xml_file in self.xml_files:
            try:
                _lxml_etree.parse(str(xml_file))
    ...
    def validate_namespaces(self):
        ...
        for xml_file in self.xml_files:
            try:
                root = _lxml_etree.parse(str(xml_file)).getroot()
    ...
    def validate_unique_ids(self):
        ...
        for xml_file in self.xml_files:
            ...
            except (_lxml_etree.XMLSyntaxError, Exception) as e:
                errors.append(
    ...
    def validate_file_references(self):
        ...
        for rels_file in rels_files:
            try:
                rels_root = _lxml_etree.parse(str(rels_file)).getroot()
    ...
    def validate_all_relationship_ids(self):
        ...
        for xml_file in self.xml_files:
            ...
            try:
                ...
                xml_root = _lxml_etree.parse(str(xml_file)).getroot()
    ...
    def validate_content_types(self):
        ...
        try:
            root = _lxml_etree.parse(str(content_types_file)).getroot()
            declared_parts = set()
            ...
            for xml_file in self.xml_files:
                ...
                try:
                    root_tag = _lxml_etree.parse(str(xml_file)).getroot().tag
    ...
    def _clean_ignorable_namespaces(self, xml_doc):
        xml_string = _lxml_etree.tostring(xml_doc, encoding="unicode")
        xml_copy = _lxml_etree.fromstring(xml_string)
        ...
        return _lxml_etree.ElementTree(xml_copy)
    ...
    def _validate_single_file_xsd(self, xml_file, base_path):
        ...
        try:
            with open(schema_path, "rb") as xsd_file:
                ...
                xsd_doc = _lxml_etree.parse(
                    xsd_file, parser=parser, base_url=str(schema_path)
                )
                schema = _lxml_etree.XMLSchema(xsd_doc)

            with open(xml_file, "r") as f:
                xml_doc = _lxml_etree.parse(f)
    ...
    def _remove_template_tags_from_text_nodes(self, xml_doc):
        ...
        return _lxml_etree.ElementTree(xml_copy), warnings
